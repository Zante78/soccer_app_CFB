...
- Wir generieren den ausgefüllten Antrag als **PDF für den Passwart** — der druckt es, holt Original-Unterschriften ein, stempelt, schickt es ein
...
### Unterschriften sind Papier-Sache
- Der WDFV verlangt **Original-Unterschriften auf Papier**:
  - Spieler (bei Volljährigen)
  - Erziehungsberechtigter (bei Minderjährigen)
  - Vereinsvertreter mit Stempel
- **Digitale Unterschrift auf Wizard** (unser Step 6) ist NICHT für WDFV — ist unser interner DSGVO-Consent + Antrag-Freigabe
- Der Passwart druckt Antrag + holt bei der Übergabe die Original-Unterschriften ein
...
1. Wizard sammelt Daten + Foto + (bei Junior) Geburtsurkunde in Supabase Storage
2. System generiert **ausgefüllten WDFV-Antrag als PDF** (später zu bauen — nicht Teil MVP)
3. Passwart bekommt Notification: "Neuer Antrag bereit"
4. Passwart druckt Antrag aus, holt Original-Unterschriften vom Spieler/Erziehungsberechtigten ein
5. Passwart stempelt vereinsseitig
6. Bot startet parallel: Trägt Spieler in DFBnet ein (Draft-Modus) + lädt Passfoto in DFBnet hoch
7. Passwart schickt Original-Antrag per Post an WDFV Duisburg (`Postfach 10 15 12, 47015 Duisburg`)
8. Verband bearbeitet, DFBnet-Status springt auf "aktiv" → Spieler ist offiziell spielberechtigt

**Wichtig für Vision:** Der Papier-Postweg zum WDFV ist Verbandsrealität und **kann nicht vom Bot automatisiert werden**. Aber wir haben den Passwart auf 5 Minuten Ausdrucken + Unterschriften einsammeln + Postweg reduziert (statt Stunden Papierkram vom Antragsteller sammeln + Formular tippen).
