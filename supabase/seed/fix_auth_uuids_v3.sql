...
-- Step 2: Insert new user records FIRST (with correct Auth UUIDs)
...
-- Step 3: Now update foreign key references (new users exist now)
...
-- Step 4: Delete old user records
