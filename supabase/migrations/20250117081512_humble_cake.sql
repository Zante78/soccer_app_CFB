...
-- Create standalone player stats function with fixed types
...
-- Create standalone search function with explicit type casting
...
-- Create basic indexes without date predicates
