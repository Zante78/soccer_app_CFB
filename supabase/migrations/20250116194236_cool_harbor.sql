...
-- Create player stats function with unique name and parameter
CREATE OR REPLACE FUNCTION get_player_stats_v1(p_id uuid)
RETURNS TABLE (
  total_teams bigint,
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION get_player_stats_v1(uuid) TO authenticated;
