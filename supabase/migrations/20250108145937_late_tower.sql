...
CREATE INDEX message_notifications_user_id_idx ON message_notifications(user_id);
CREATE INDEX message_notifications_message_id_idx ON message_notifications(message_id);
