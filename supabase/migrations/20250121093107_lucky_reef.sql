...
CREATE POLICY "storage_objects_exports_policy_20250121"
ON storage.objects
FOR ALL
TO authenticated
...
-- Add comment
COMMENT ON POLICY "storage_objects_exports_policy_20250121" ON storage.objects IS 'Controls access to export files in storage (created 2025-01-21)';